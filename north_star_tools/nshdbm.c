...
main (int argc, char **argv)
{
  ...
  printf ("                               [ 1 DIB is 16 sectors unless a power-of-2 factor is applied ]\n\n");
  init_bitmap ();
...
ltype (int tnum)
{
  ...
  static char *t0 = "Default Type";
  static char *t1 = "Executable, TypeData=GO";
  ...
  static char *tacct = "ACCOUNT directory entry";
  if (!xdir.accid_nshdd)
    {
